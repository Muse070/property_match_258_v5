...
class EditMap extends StatefulWidget {
  ...
  @override
  State<EditMap> createState() => _ViewMapState();
}

class _ViewMapState extends State<EditMap> {
  final GlobalKey _markerIconKey = GlobalKey();

  late Marker marker;
  final _locationController = Get.find<EditPropertyController>();
  ...
  //   target: LatLng(-15.4206208, 28.3082752),
  //   zoom: 18,
  // );
  ...
  Marker _getMarker(double lat, double lng) {
    return Marker(
      ...
      onDragEnd: (newPosition) {
        _locationController.latitude.value = newPosition.latitude;
        _locationController.longitude.value = newPosition.longitude;
        print(
  ...
  Future<void> setLatLng() async {
    ...
    _locationController.latitude.value = lat;
    _locationController.longitude.value = lng;
  }
        ...
        body: Stack(children: [
          GoogleMap(
            ...
            onTap: (LatLng latLng) {
              ...
              _locationController.latitude.value = latLng.latitude;
              _locationController.longitude.value = latLng.longitude;
            },
